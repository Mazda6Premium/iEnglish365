...
class TabPairVC: UIViewController {
    ...
    func setUpNavigationBar() {
        ...
        navigationItem.title = "Choose the pair"
...
extension TabPairVC: UITableViewDelegate, UITableViewDataSource {
